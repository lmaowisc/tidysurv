...
:::
::: chapter-text
### [Nonparametric Estimation and Graphics](np.qmd) {.unnumbered}
...
::: origin-note
These materials grew out of my short course taught at the 2025 Joint Statistical Meetings. The original slides remain available as companions to the developing text. [Find the code, data, and slides →](resources.qmd)
:::
