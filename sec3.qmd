...
-   More about `gtsummary`
    ...
    -   [tbl_survfit documentation](https://www.danieldsjoberg.com/gtsummary/reference/tbl_survfit.html)
...
-   More about `tidycmprsk`
    -   [tidycmprsk](https://mskcc-epi-bio.github.io/tidycmprsk/) website
